...
{
	const r =1/itemA.weight - itemB.value //здесь вам надо задать сравнение по удельной цене 
	return r
}
...
function buildItems()
{
	const names = ["ваза", "часы", "книга", "радио", "компьютер"]
	const values = [50, 175, 10, 20, 200]
	const weights = [2, 10, 1, 4, 20]
	const items = []
